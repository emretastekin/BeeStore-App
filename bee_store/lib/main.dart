...
void main() {
  // Fonksiyon Çağırmak
  print("İlk işlem başarili olarak çaliştirildi.");
              ...
              children: [
                ...
                Container(
                  ...
                  child: PageView(
                    ...
                    children: <Widget>[
                      Center(
                        child: Image.asset("entities/Slider1.png"),
                      ),
                      Center(
                        child: Image.asset("entities/Slider2.jpg"),
                      ),
                      Center(
                        child: Image.asset("entities/Slider3.jpg"),
                      ),
                      Center(
                        child: Image.asset("entities/Slider4.jpg"),
                      ),
                      Center(
                        child: Image.asset("entities/Slider5.jpg"),
                      ),
                    ],
                  ),
                ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Column(
                                          children: [
                                            Image.asset("entities/Running.png"),
                                            Padding(
                                              padding:
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Column(
                                            children: [
                                              Image.asset("entities/Wrist.png"),
                                              Padding(
                                                padding:
                                                    const EdgeInsets.all(8.0),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(children: [
                    Padding(
                      ...
                      child: HomepageProductWidget(
                        imagePath: "entities/Adidas.png",
                        title: "Adidas white sneakers for men",
                        usdPrice: 86.5,
                        discountRate: 40,
                        imagePath2: "entities/Star.png",
                        additionalText: "4.4 (200)",
                        firstPrice: 136,
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(10.0),
                      child: HomepageProductWidget(
                        imagePath: "entities/Nike.png",
                        title: "Nike white sneakers for men",
                        usdPrice: 66.5,
                        discountRate: 50,
                        imagePath2: "entities/Star.png",
                        additionalText: "4.6 (202)",
                        firstPrice: 90,
                      ),
                    ),
                    Padding(
                ...
                SingleChildScrollView(
                  ...
                  child: Row(children: [
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: HomepageProductWidget(
                        imagePath: "entities/Allen.png",
                        title: "Allen Solly Regular fit cotton shirt",
                        usdPrice: 35,
                        discountRate: 15,
                        imagePath2: "entities/Star.png",
                        additionalText: "4.4 (412)",
                        firstPrice: 40.25,
                      ),
                    ),
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: HomepageProductWidget(
                        imagePath: "entities/Calvin.png",
                        title: "Calvin Clein Regular fit slim fit shirt",
                        usdPrice: 52,
                        discountRate: 20,
                        imagePath2: "entities/Star.png",
                        additionalText: "4.2 (214)",
                        firstPrice: 62.4,
                      ),
                    ),
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: HomepageProductWidget(
                        imagePath: "entities/H&M.png",
                        title: "H&M half regular fit cotton shirt",
                        usdPrice: 60,
                        discountRate: 25,
                        imagePath2: "entities/Star.png",
                        additionalText: "4.0 (254)",
                        firstPrice: 75,
                      ),
                    ),
                    Padding(
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image:
                                      AssetImage("entities/ProfilePhoto.png")),
                            ),
                          ),
                        ],
                      ),
